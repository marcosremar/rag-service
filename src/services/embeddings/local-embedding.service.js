...
export class LocalEmbeddingService {
    ...
    async initialize() {
        ...
        try {
            ...
            throw new Error(`Failed to load local embedding model "${this.model}": ${errorMessage}. ` +
    ...
    getExpectedDimensions() {
        if (this.model.includes('bge-small'))
            return 384;
        if (this.model.includes('bge-base'))
            return 768;
        if (this.model.includes('bge-large'))
            return 1024;
